...
with st.expander("📘 권리분석 고도화 매뉴얼(실무 학습용)", expanded=False):
    ...
    manual_p31_path = Path(__file__).resolve().parent / "docs" / "31_p31_1차판정게이트_검수표_v1.md"
    manual_p32_path = Path(__file__).resolve().parent / "docs" / "32_p32_권리분석결론템플릿_검수표_v1.md"
    manual_p33_path = Path(__file__).resolve().parent / "docs" / "33_p33_취하프로세스시작조건_검수표_v1.md"
    manual_p34_path = Path(__file__).resolve().parent / "docs" / "34_p34_채권자유형분류_검수표_v1.md"
    manual_p35_path = Path(__file__).resolve().parent / "docs" / "35_p35_회수비교프레임생성_검수표_v1.md"
    manual_p36_path = Path(__file__).resolve().parent / "docs" / "36_p36_제안조건최소세트_검수표_v1.md"
    manual_p37_path = Path(__file__).resolve().parent / "docs" / "37_p37_반론대응준비도_검수표_v1.md"
    manual_p38_path = Path(__file__).resolve().parent / "docs" / "38_p38_회수시점개선문구_검수표_v1.md"
    manual_p39_path = Path(__file__).resolve().parent / "docs" / "39_p39_리스크병기의무_검수표_v1.md"
    manual_p40_path = Path(__file__).resolve().parent / "docs" / "40_p40_협상우선순위큐_검수표_v1.md"
    ...
    manual_p47_path = Path(__file__).resolve().parent / "docs" / "47_p47_로그증빙필수화_검수표_v1.md"
    manual_p48_path = Path(__file__).resolve().parent / "docs" / "48_p48_최종취하스크립트조합_검수표_v1.md"
    manual_p49_path = Path(__file__).resolve().parent / "docs" / "49_p49_운영태그버전기록_검수표_v1.md"
    manual_p50_path = Path(__file__).resolve().parent / "docs" / "50_p50_릴리스게이트_검수표_v1.md"
    ...
    manual_p31_name = "31_p31_1차판정게이트_검수표_v1.md"
    manual_p32_name = "32_p32_권리분석결론템플릿_검수표_v1.md"
    manual_p33_name = "33_p33_취하프로세스시작조건_검수표_v1.md"
    manual_p34_name = "34_p34_채권자유형분류_검수표_v1.md"
    manual_p35_name = "35_p35_회수비교프레임생성_검수표_v1.md"
    manual_p36_name = "36_p36_제안조건최소세트_검수표_v1.md"
    manual_p37_name = "37_p37_반론대응준비도_검수표_v1.md"
    manual_p38_name = "38_p38_회수시점개선문구_검수표_v1.md"
    manual_p39_name = "39_p39_리스크병기의무_검수표_v1.md"
    manual_p40_name = "40_p40_협상우선순위큐_검수표_v1.md"
    ...
    manual_p47_name = "47_p47_로그증빙필수화_검수표_v1.md"
    manual_p48_name = "48_p48_최종취하스크립트조합_검수표_v1.md"
    manual_p49_name = "49_p49_운영태그버전기록_검수표_v1.md"
    manual_p50_name = "50_p50_릴리스게이트_검수표_v1.md"
    ...
    try:
        ...
        manual_p31_text = read_utf8_text_file(
            str(manual_p31_path),
            manual_p31_path.stat().st_mtime if manual_p31_path.exists() else 0.0,
        )
        manual_p32_text = read_utf8_text_file(
            str(manual_p32_path),
            manual_p32_path.stat().st_mtime if manual_p32_path.exists() else 0.0,
        )
        manual_p33_text = read_utf8_text_file(
            str(manual_p33_path),
            manual_p33_path.stat().st_mtime if manual_p33_path.exists() else 0.0,
        )
        manual_p34_text = read_utf8_text_file(
            str(manual_p34_path),
            manual_p34_path.stat().st_mtime if manual_p34_path.exists() else 0.0,
        )
        manual_p35_text = read_utf8_text_file(
            str(manual_p35_path),
            manual_p35_path.stat().st_mtime if manual_p35_path.exists() else 0.0,
        )
        manual_p36_text = read_utf8_text_file(
            str(manual_p36_path),
            manual_p36_path.stat().st_mtime if manual_p36_path.exists() else 0.0,
        )
        manual_p37_text = read_utf8_text_file(
            str(manual_p37_path),
            manual_p37_path.stat().st_mtime if manual_p37_path.exists() else 0.0,
        )
        manual_p38_text = read_utf8_text_file(
            str(manual_p38_path),
            manual_p38_path.stat().st_mtime if manual_p38_path.exists() else 0.0,
        )
        manual_p39_text = read_utf8_text_file(
            str(manual_p39_path),
            manual_p39_path.stat().st_mtime if manual_p39_path.exists() else 0.0,
        )
        manual_p40_text = read_utf8_text_file(
            str(manual_p40_path),
            manual_p40_path.stat().st_mtime if manual_p40_path.exists() else 0.0,
        )
        manual_p41_text = read_utf8_text_file(
            str(manual_p41_path),
            manual_p41_path.stat().st_mtime if manual_p41_path.exists() else 0.0,
        )
        manual_p42_text = read_utf8_text_file(
            str(manual_p42_path),
            manual_p42_path.stat().st_mtime if manual_p42_path.exists() else 0.0,
        )
        ...
        manual_p47_text = read_utf8_text_file(
            str(manual_p47_path),
            manual_p47_path.stat().st_mtime if manual_p47_path.exists() else 0.0,
        )
        manual_p48_text = read_utf8_text_file(
            str(manual_p48_path),
            manual_p48_path.stat().st_mtime if manual_p48_path.exists() else 0.0,
        )
        manual_p49_text = read_utf8_text_file(
            str(manual_p49_path),
            manual_p49_path.stat().st_mtime if manual_p49_path.exists() else 0.0,
        )
        manual_p50_text = read_utf8_text_file(
            str(manual_p50_path),
            manual_p50_path.stat().st_mtime if manual_p50_path.exists() else 0.0,
        )
    ...
    if manual_p31_text:
        with st.expander("다음 검수 페이지: p31 1차 판정 게이트", expanded=False):
            p31_col1, p31_col2 = st.columns(2)
            with p31_col1:
                st.download_button(
                    "📥 p31 검수표 다운로드 (MD)",
                    data=manual_p31_text,
                    file_name=manual_p31_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p31_col2:
                st.download_button(
                    "📥 p31 검수표 다운로드 (TXT)",
                    data=manual_p31_text,
                    file_name=manual_p31_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p31_text)

    if manual_p32_text:
        with st.expander("다음 검수 페이지: p32 권리분석 결론 템플릿", expanded=False):
            p32_col1, p32_col2 = st.columns(2)
            with p32_col1:
                st.download_button(
                    "📥 p32 검수표 다운로드 (MD)",
                    data=manual_p32_text,
                    file_name=manual_p32_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p32_col2:
                st.download_button(
                    "📥 p32 검수표 다운로드 (TXT)",
                    data=manual_p32_text,
                    file_name=manual_p32_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p32_text)

    if manual_p33_text:
        with st.expander("다음 검수 페이지: p33 취하 프로세스 시작조건", expanded=False):
            p33_col1, p33_col2 = st.columns(2)
            with p33_col1:
                st.download_button(
                    "📥 p33 검수표 다운로드 (MD)",
                    data=manual_p33_text,
                    file_name=manual_p33_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p33_col2:
                st.download_button(
                    "📥 p33 검수표 다운로드 (TXT)",
                    data=manual_p33_text,
                    file_name=manual_p33_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p33_text)

    if manual_p34_text:
        with st.expander("다음 검수 페이지: p34 채권자 유형 분류", expanded=False):
            p34_col1, p34_col2 = st.columns(2)
            with p34_col1:
                st.download_button(
                    "📥 p34 검수표 다운로드 (MD)",
                    data=manual_p34_text,
                    file_name=manual_p34_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p34_col2:
                st.download_button(
                    "📥 p34 검수표 다운로드 (TXT)",
                    data=manual_p34_text,
                    file_name=manual_p34_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p34_text)

    if manual_p35_text:
        with st.expander("다음 검수 페이지: p35 회수 비교 프레임 생성", expanded=False):
            p35_col1, p35_col2 = st.columns(2)
            with p35_col1:
                st.download_button(
                    "📥 p35 검수표 다운로드 (MD)",
                    data=manual_p35_text,
                    file_name=manual_p35_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p35_col2:
                st.download_button(
                    "📥 p35 검수표 다운로드 (TXT)",
                    data=manual_p35_text,
                    file_name=manual_p35_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p35_text)

    if manual_p36_text:
        with st.expander("다음 검수 페이지: p36 제안 조건 최소 세트", expanded=False):
            p36_col1, p36_col2 = st.columns(2)
            with p36_col1:
                st.download_button(
                    "📥 p36 검수표 다운로드 (MD)",
                    data=manual_p36_text,
                    file_name=manual_p36_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p36_col2:
                st.download_button(
                    "📥 p36 검수표 다운로드 (TXT)",
                    data=manual_p36_text,
                    file_name=manual_p36_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p36_text)

    if manual_p37_text:
        with st.expander("다음 검수 페이지: p37 반론 대응 준비도", expanded=False):
            p37_col1, p37_col2 = st.columns(2)
            with p37_col1:
                st.download_button(
                    "📥 p37 검수표 다운로드 (MD)",
                    data=manual_p37_text,
                    file_name=manual_p37_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p37_col2:
                st.download_button(
                    "📥 p37 검수표 다운로드 (TXT)",
                    data=manual_p37_text,
                    file_name=manual_p37_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p37_text)

    if manual_p38_text:
        with st.expander("다음 검수 페이지: p38 회수시점 개선 문구", expanded=False):
            p38_col1, p38_col2 = st.columns(2)
            with p38_col1:
                st.download_button(
                    "📥 p38 검수표 다운로드 (MD)",
                    data=manual_p38_text,
                    file_name=manual_p38_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p38_col2:
                st.download_button(
                    "📥 p38 검수표 다운로드 (TXT)",
                    data=manual_p38_text,
                    file_name=manual_p38_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p38_text)

    if manual_p39_text:
        with st.expander("다음 검수 페이지: p39 리스크 병기 의무", expanded=False):
            p39_col1, p39_col2 = st.columns(2)
            with p39_col1:
                st.download_button(
                    "📥 p39 검수표 다운로드 (MD)",
                    data=manual_p39_text,
                    file_name=manual_p39_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p39_col2:
                st.download_button(
                    "📥 p39 검수표 다운로드 (TXT)",
                    data=manual_p39_text,
                    file_name=manual_p39_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p39_text)

    if manual_p40_text:
        with st.expander("다음 검수 페이지: p40 협상 우선순위 큐", expanded=False):
            p40_col1, p40_col2 = st.columns(2)
            with p40_col1:
                st.download_button(
                    "📥 p40 검수표 다운로드 (MD)",
                    data=manual_p40_text,
                    file_name=manual_p40_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p40_col2:
                st.download_button(
                    "📥 p40 검수표 다운로드 (TXT)",
                    data=manual_p40_text,
                    file_name=manual_p40_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p40_text)

    if manual_p41_text:
        with st.expander("다음 검수 페이지: p41 담보구조 기반 설명", expanded=False):
            p41_col1, p41_col2 = st.columns(2)
            with p41_col1:
                st.download_button(
                    "📥 p41 검수표 다운로드 (MD)",
                    data=manual_p41_text,
                    file_name=manual_p41_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p41_col2:
                st.download_button(
                    "📥 p41 검수표 다운로드 (TXT)",
                    data=manual_p41_text,
                    file_name=manual_p41_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p41_text)

    if manual_p42_text:
        with st.expander("다음 검수 페이지: p42 공공/조세채권 제한사항", expanded=False):
            p42_col1, p42_col2 = st.columns(2)
            with p42_col1:
                st.download_button(
                    "📥 p42 검수표 다운로드 (MD)",
                    data=manual_p42_text,
                    file_name=manual_p42_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p42_col2:
                st.download_button(
                    "📥 p42 검수표 다운로드 (TXT)",
                    data=manual_p42_text,
                    file_name=manual_p42_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p42_text)

    if manual_p43_text:
        with st.expander("다음 검수 페이지: p43 1금융 스크립트 기준", expanded=False):
            p43_col1, p43_col2 = st.columns(2)
            with p43_col1:
                st.download_button(
                    "📥 p43 검수표 다운로드 (MD)",
                    data=manual_p43_text,
                    file_name=manual_p43_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p43_col2:
                st.download_button(
                    "📥 p43 검수표 다운로드 (TXT)",
                    data=manual_p43_text,
                    file_name=manual_p43_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
    ...
    if manual_p45_text:
        with st.expander("다음 검수 페이지: p45 유동화/NPL 대응 문구", expanded=False):
            p45_col1, p45_col2 = st.columns(2)
            with p45_col1:
                st.download_button(
                    "📥 p45 검수표 다운로드 (MD)",
                    data=manual_p45_text,
                    file_name=manual_p45_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p45_col2:
                st.download_button(
                    "📥 p45 검수표 다운로드 (TXT)",
                    data=manual_p45_text,
                    file_name=manual_p45_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
    ...
    if manual_p47_text:
        with st.expander("다음 검수 페이지: p47 로그/증빙 필수화", expanded=False):
            p47_col1, p47_col2 = st.columns(2)
            with p47_col1:
                st.download_button(
                    "📥 p47 검수표 다운로드 (MD)",
                    data=manual_p47_text,
                    file_name=manual_p47_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p47_col2:
                st.download_button(
                    "📥 p47 검수표 다운로드 (TXT)",
                    data=manual_p47_text,
                    file_name=manual_p47_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p47_text)

    if manual_p48_text:
        with st.expander("다음 검수 페이지: p48 최종 취하 스크립트 조합", expanded=False):
            p48_col1, p48_col2 = st.columns(2)
            with p48_col1:
                st.download_button(
                    "📥 p48 검수표 다운로드 (MD)",
                    data=manual_p48_text,
                    file_name=manual_p48_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p48_col2:
                st.download_button(
                    "📥 p48 검수표 다운로드 (TXT)",
                    data=manual_p48_text,
                    file_name=manual_p48_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p48_text)

    if manual_p49_text:
        with st.expander("다음 검수 페이지: p49 운영 태그/버전 기록", expanded=False):
            p49_col1, p49_col2 = st.columns(2)
            with p49_col1:
                st.download_button(
                    "📥 p49 검수표 다운로드 (MD)",
                    data=manual_p49_text,
                    file_name=manual_p49_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p49_col2:
                st.download_button(
                    "📥 p49 검수표 다운로드 (TXT)",
                    data=manual_p49_text,
                    file_name=manual_p49_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p49_text)

    if manual_p50_text:
        with st.expander("다음 검수 페이지: p50 릴리스 게이트", expanded=False):
            p50_col1, p50_col2 = st.columns(2)
            with p50_col1:
                st.download_button(
                    "📥 p50 검수표 다운로드 (MD)",
                    data=manual_p50_text,
                    file_name=manual_p50_name,
                    mime="text/markdown",
                    use_container_width=True,
                )
            with p50_col2:
                st.download_button(
                    "📥 p50 검수표 다운로드 (TXT)",
                    data=manual_p50_text,
                    file_name=manual_p50_name.replace(".md", ".txt"),
                    mime="text/plain",
                    use_container_width=True,
                )
            st.markdown(manual_p50_text)
